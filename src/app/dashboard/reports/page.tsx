...
import { FileText, FileUp, Database, Server, Spline, Sparkles, Info, Loader2 } from 'lucide-react';
...
export default function ReportsPage() {
  ...
  const { buildings, itemsByRoom, equipment, connections, users, systemSettings } = useInfra();
  ...
  const handleGenerateHtmlReport = () => {
    ...
    // Give a moment for the state to update and show the loader
    setTimeout(() => {
        const printPromise = new Promise((resolve) => {
            // Afterprint event may not be reliable in all browsers, 
            // but it's the best we can do without complex logic.
        ...
        // Set a timeout to ensure the loader is turned off even if afterprint doesn't fire
